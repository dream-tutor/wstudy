...
<div class="agree-box">
<label class="agree" for="fAgree"><input type="checkbox" id="fAgree" required><span>개인정보 수집·이용에 동의합니다 <em>(필수)</em></span></label>
<details class="agree-more"><summary>수집 항목과 보유 기간 보기</summary>
<ul>
...
<label class="agree" for="fAgree3" style="margin-top:12px"><input type="checkbox" id="fAgree3" required><span>상담 지점에 개인정보를 제공하는 데 동의합니다 <em>(필수)</em></span></label>
<details class="agree-more"><summary>받는 곳과 제공 항목 보기</summary>
<ul>
<li><b>받는 곳</b>상담을 맡을 와와 지점(지점마다 따로 등록된 학원)</li>
<li><b>제공 목적</b>상담 연락과 수업·지점 안내</li>
<li><b>제공 항목</b>학생 이름, 연락처, 주소, 학년, 희망 과목, 학교 이름(적은 경우)</li>
<li><b>보유 기간</b>상담 목적을 이루면 지체 없이 파기합니다. 법령에 따라 보관해야 하는 정보는 그 기간 동안만 보관합니다.</li>
<li><b>동의 거부</b>동의를 거부할 수 있습니다. 거부하시면 온라인 상담 신청은 할 수 없고, 전화 상담은 그대로 이용할 수 있습니다.</li>
</ul>
</details>
...
(function(){
  ...
  document.getElementById('f').addEventListener('submit',function(e){
    ...
    if(!document.getElementById('fAgree3').checked){alert('상담 지점에 개인정보를 제공하는 데 동의해 주셔야 상담 신청이 접수됩니다.');document.getElementById('fAgree3').focus();return;}
