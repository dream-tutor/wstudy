...
<input name="거주주소" id="fAddr" required placeholder="예: 경기 군포시 산본로 394" style="flex:1;min-width:0">
...
(function(){
  ...
  document.getElementById('f').addEventListener('submit',function(e){
    ...
    if(!f.거주주소.value.trim()){alert('주소를 입력해 주세요. 도로명 검색 또는 직접 입력 모두 가능합니다.');f.거주주소.focus();return;}
